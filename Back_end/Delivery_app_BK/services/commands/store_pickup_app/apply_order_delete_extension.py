"""Store Pickup App - Order Delete Extension Handler (no-op).

Store pickup plans do not require custom order delete processing.
"""
...
def apply_order_delete_extension(
    ...
    """Store pickup plans don't require order delete processing.
