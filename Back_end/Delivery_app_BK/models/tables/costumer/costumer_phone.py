...
class CostumerPhone(db.Model, TeamScopedMixin):
    __tablename__ = "costumer_phone"
    ...
    phone = Column(JSONB().with_variant(JSON, "sqlite"), nullable=True)
    ...
    __table_args__ = (
        Index("ix_costumer_phone_phone_gin", "phone", postgresql_using="gin"),
    )
