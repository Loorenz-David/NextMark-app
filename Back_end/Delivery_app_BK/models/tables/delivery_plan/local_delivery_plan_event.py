...
class LocalDeliveryPlanEvent(db.Model, TeamScopedMixin, DispatchStateMixin):
    __tablename__ = "local_delivery_plan_event"
    ...
    local_delivery_plan = relationship("LocalDeliveryPlan", backref="events", lazy="selectin")
    actor = relationship("User", lazy="selectin")
    team = relationship("Team", backref="local_delivery_plan_events", lazy=True)
