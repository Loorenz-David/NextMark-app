...
class RouteSolutionEvent(db.Model, TeamScopedMixin, DispatchStateMixin):
    __tablename__ = "route_solution_event"
    ...
    route_solution = relationship("RouteSolution", backref="events", lazy="selectin")
    actor = relationship("User", lazy="selectin")
    team = relationship("Team", backref="route_solution_events", lazy=True)
