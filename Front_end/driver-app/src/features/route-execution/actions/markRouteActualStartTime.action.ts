...
export async function markRouteActualStartTimeAction(routeId: number, observedTime?: string | null) {
  const response = await markRouteActualStartTimeApi(routeId, { observed_time: observedTime ?? null })
