...
export async function markRouteActualEndTimeLastOrderAction(routeId: number, observedTime?: string | null) {
  const response = await markRouteActualEndTimeLastOrderApi(routeId, { observed_time: observedTime ?? null })
