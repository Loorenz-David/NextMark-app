...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: /^zustand$/, replacement: path.resolve(__dirname, '../admin-app/node_modules/zustand/esm/index.mjs') },
      { find: /^zustand\/react$/, replacement: path.resolve(__dirname, '../admin-app/node_modules/zustand/esm/react.mjs') },
      { find: /^zustand\/react\/shallow$/, replacement: path.resolve(__dirname, '../admin-app/node_modules/zustand/esm/react/shallow.mjs') },
      ...
      { find: /^socket\.io-client$/, replacement: path.resolve(__dirname, '../admin-app/node_modules/socket.io-client/build/esm/index.js') },
    ],
  },
  server:{
    host:true
