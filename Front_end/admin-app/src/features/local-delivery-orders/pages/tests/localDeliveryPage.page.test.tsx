...
import { LocalDeliveryPage, LocalDeliveryPageLayout } from '../LocalDelivery.page'
...
export const runLocalDeliveryPageTests = () => {
  assert(
    LocalDeliveryPage({ payload: {} }) === null,
    'page should return null when planId is missing',
  )

  const pageElement = LocalDeliveryPage({ payload: { planId: 42 } })
