import type { LocalDeliveryPlanSettingsPayload } from '@/features/plan/planTypes/localDelivery/api/localDeliveryPlanSettings.api'
...
import { serviceTimeMinutesToSeconds } from '@/features/plan/planTypes/localDelivery/domain/serviceTimeUnits'
...
export const normalizeLocalDeliveryEditFormToSettingsPayload = (
  ...
  local_delivery_plan_id: formState.local_delivery_plan_id ?? 0,
  delivery_plan: {
