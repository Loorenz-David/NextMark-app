...
import {
  buildRouteGroupSelectionFromClientIds,
  expandRouteGroupClientIdsFromMarkerSelection,
} from '../routeGroupCircleSelection.flow'
...
export const runRouteGroupCircleSelectionFlowTests = () => {
  ...
  const selection = buildRouteGroupSelectionFromClientIds(
  ...
  const expanded = expandRouteGroupClientIdsFromMarkerSelection(
