...
import { getRouteGroupBoundaryLocations } from '@/features/plan/routeGroup/domain/getRouteGroupBoundaryLocations'
...
export const useRouteGroupDerivedResources = ({
  ...
  const boundaryLocations = useMemo(
    () => getRouteGroupBoundaryLocations(stopByOrderId, ordersById, selectedRouteSolution),
