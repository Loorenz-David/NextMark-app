...
import type { RouteGroupSummaryMetric } from "./routeGroupStatsOverlay.types";
import {
...
type InlineRouteMetricProps = {
  metric: RouteGroupSummaryMetric;
  routeScopeKey: string;
};

export const InlineRouteMetric = ({
  metric,
  routeScopeKey,
}: InlineRouteMetricProps) => {
