...
export const selectRouteGroupByClientId = (clientId: string | null | undefined) =>
  (state: EntityTable<RouteGroup>) =>
    selectByClientId<RouteGroup>(clientId)(state)

export const selectRouteGroupByServerId = (id: number | null | undefined) =>
  (state: EntityTable<RouteGroup>) =>
    selectByServerId<RouteGroup>(id)(state)

export const selectRouteGroupsByPlanId = (planId: number | null | undefined) =>
  (state: EntityTable<RouteGroup>) => {
...
export const getPlanEndDateByRouteGroupId = (routeGroupId?: number | null) => {
  ...
  const localPlan = selectRouteGroupByServerId(routeGroupId)(useRouteGroupStore.getState())
...
export const insertRouteGroups = (table: { byClientId: Record<string, RouteGroup>; allIds: string[] }) =>
...
export const upsertRouteGroups = (table: { byClientId: Record<string, RouteGroup>; allIds: string[] }) => {
...
export const updateRouteGroup = (clientId: string, updater: (plan: RouteGroup) => RouteGroup) =>
...
export const clearRouteGroups = () =>
  useRouteGroupStore.getState().clear()
