...
export const selectAllRoutePlans = (state: EntityTable<DeliveryPlan>) => selectRoutePlansInternal(state)
const selectVisibleRoutePlansInternal = selectVisible<DeliveryPlan>()
export const selectVisibleRoutePlans = (state: EntityTable<DeliveryPlan>) => selectVisibleRoutePlansInternal(state)

export const selectRoutePlanByClientId = (clientId: string | null | undefined) =>
  (state: EntityTable<DeliveryPlan>) =>
    selectByClientId<DeliveryPlan>(clientId)(state)

export const selectRoutePlanByServerId = (id: number | null | undefined) =>
  (state: EntityTable<DeliveryPlan>) =>
    selectByServerId<DeliveryPlan>(id)(state)

export const selectRoutePlanStateById = (stateId: number | null | undefined) =>
...
export const insertRoutePlans = (table: { byClientId: Record<string, DeliveryPlan>; allIds: string[] }) =>
...
export const upsertRoutePlan = (routePlan: DeliveryPlan) => {
  ...
  if (state.byClientId[routePlan.client_id]) {
    state.update(routePlan.client_id, (existing) => ({ ...existing, ...routePlan }))
    return
  }
  state.insert(routePlan)
}

export const upsertRoutePlans = (table: { byClientId: Record<string, DeliveryPlan>; allIds: string[] }) => {
...
export const updateRoutePlan = (clientId: string, updater: (routePlan: DeliveryPlan) => DeliveryPlan) =>
...
export const clearRoutePlans = () =>
  useRoutePlanStore.getState().clear()
