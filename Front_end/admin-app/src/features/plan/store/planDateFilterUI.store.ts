...
export const usePlanDateFilterUIStore = create<PlanDateFilterUIState>((set) => ({
...
export const usePlanDateFilterUIState = () => {
  const mode = usePlanDateFilterUIStore((state) => state.mode)
  const singleDateIso = usePlanDateFilterUIStore((state) => state.singleDateIso)
  const rangeStartIso = usePlanDateFilterUIStore((state) => state.rangeStartIso)
  const rangeEndIso = usePlanDateFilterUIStore((state) => state.rangeEndIso)
...
export const usePlanDateFilterUIActions = () => {
  const setMode = usePlanDateFilterUIStore((state) => state.setMode)
  const setSingleDate = usePlanDateFilterUIStore((state) => state.setSingleDate)
  const setRangeStart = usePlanDateFilterUIStore((state) => state.setRangeStart)
  const setRangeEnd = usePlanDateFilterUIStore((state) => state.setRangeEnd)
