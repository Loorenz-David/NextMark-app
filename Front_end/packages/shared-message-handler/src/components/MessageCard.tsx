...
function TriangleWarningIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" viewBox="0 0 24 24" {...props}>
      <path d="M12 4 21 19H3L12 4Z" stroke="currentColor" strokeLinejoin="round" strokeWidth="2" />
      <path d="M12 9v4.5" stroke="currentColor" strokeLinecap="round" strokeWidth="2" />
...
function InfoIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" viewBox="0 0 24 24" {...props}>
      <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="2" />
      <path d="M12 11v5" stroke="currentColor" strokeLinecap="round" strokeWidth="2" />
...
function CloseIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" viewBox="0 0 24 24" {...props}>
      <path d="M7 7 17 17" stroke="currentColor" strokeLinecap="round" strokeWidth="2" />
      <path d="M17 7 7 17" stroke="currentColor" strokeLinecap="round" strokeWidth="2" />
    </svg>
  )
}
      ...
      >
        <div className="flex items-center gap-3 pr-6">
          ...
          <div className="flex flex-1 flex-col gap-2">
            ...
            {hasDetails && isExpanded ? <p className="text-xs leading-relaxed text-white/90">{details}</p> : null}
          </div>
        </div>
        <button
