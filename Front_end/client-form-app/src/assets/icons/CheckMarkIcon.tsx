/**
 * CheckMarkIcon — inline SVG React component.
 *
 * Path data is derived from admin-app/src/assets/icons/CheckMarkIcon.svg.
 * Accepts `className` so callers can size and colour it via Tailwind utilities
 * (e.g. `className="h-7 w-7"`).  Colour is inherited from `currentColor`.
 */
type Props = {
  className?: string
}
